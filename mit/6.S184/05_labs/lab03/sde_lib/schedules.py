...
class Alpha(ABC):
    ...
    def __call__(self, t: torch.Tensor) -> torch.Tensor:
        ...
        Returns:
            torch.Tensor: Alpha values at each time.
                Shape: (batch_size, 1, 1, 1)  ← matches input for broadcasting
        """
        pass
    ...
    def dt(self, t: torch.Tensor) -> torch.Tensor:
        ...
        """
        t_in = t.unsqueeze(1)  # (batch_size, 1, 1, 1, 1)
        dt = vmap(jacrev(self))(t_in)  # (batch_size, 1, 1, 1, 1, 1)
        return dt.view_as(t)
...
class LinearBeta(Beta):
    """
    Linear beta schedule: β_t = 1 - t.

    This matches the lab03 requirement and keeps broadcasting-friendly shape
    (batch_size, 1, 1, 1).
    """
    ...
    def dt(self, t: torch.Tensor) -> torch.Tensor:
        ...
        Returns:
            torch.Tensor: Derivative values (-1).
                Shape: (batch_size, 1, 1, 1)
        """
        return -torch.ones_like(t)
